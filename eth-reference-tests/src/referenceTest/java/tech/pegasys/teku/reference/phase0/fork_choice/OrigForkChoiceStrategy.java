...
public class OrigForkChoiceStrategy implements ForkChoiceStrategy {
  ...
  public OrigForkChoiceStrategy(UpdatableStore store) {
    ...
    if (!finalizedCheckpointAndBlock.getBlock().getMessage().getSlot().equals(UnsignedLong.ZERO)) {
      throw new IllegalArgumentException();
    }
    onBlock(store, finalizedCheckpointAndBlock.getBlock().getMessage());
  }
  ...
  @Override
  public void onBlock(ReadOnlyStore store, BeaconBlock block) {
