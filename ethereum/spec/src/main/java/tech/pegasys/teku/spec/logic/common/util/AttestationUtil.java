...
public abstract class AttestationUtil {
  ...
  public AttestationProcessingResult isValidIndexedAttestation(
    ...
    return isValidIndexedAttestation(fork, state, attestation, specConfig.getBLSSignatureVerifier());
  }
  ...
  public AttestationProcessingResult isValidIndexedAttestation(
    ...
    return isValidIndexedAttestation(fork, state, indexedAttestation, specConfig.getBLSSignatureVerifier());
  }
